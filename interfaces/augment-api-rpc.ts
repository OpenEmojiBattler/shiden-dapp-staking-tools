...
declare module '@polkadot/rpc-core/types.jsonrpc' {
  export interface RpcInterface {
    ...
    contracts: {
       ...
       **/
      call: AugmentedRpc<(callRequest: ContractCallRequest | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<ContractExecResult>>;
      /**
       ...
       **/
      instantiate: AugmentedRpc<(request: InstantiateRequest | string | Uint8Array, at?: BlockHash | string | Uint8Array) => Observable<ContractInstantiateResult>>;
      /**
    ...
    eth: {
       ...
       **/
      call: AugmentedRpc<(request: EthCallRequest | string | Uint8Array, number?: BlockNumber | AnyNumber | Uint8Array) => Observable<Bytes>>;
      /**
       ...
       **/
      estimateGas: AugmentedRpc<(request: EthCallRequest | string | Uint8Array, number?: BlockNumber | AnyNumber | Uint8Array) => Observable<U256>>;
      /**
       ...
       **/
      getLogs: AugmentedRpc<(filter: EthFilter | string | Uint8Array) => Observable<Vec<EthLog>>>;
      /**
       ...
       **/
      newFilter: AugmentedRpc<(filter: EthFilter | string | Uint8Array) => Observable<U256>>;
      /**
       * Returns id of new block filter.
       **/
       ...
       **/
      sendTransaction: AugmentedRpc<(tx: EthTransactionRequest | string | Uint8Array) => Observable<H256>>;
      /**
